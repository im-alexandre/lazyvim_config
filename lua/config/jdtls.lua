local function get_jdtls()
  local jdtls_path = vim.fn.expand(vim.fn.stdpath("data") .. "/mason/packages/jdtls")
...
local function get_bundles()
  ...
  local java_debug_path = vim.fn.expand(vim.fn.stdpath("data") .. "/mason/packages/java-debug-adapter")
  ...
  local java_test_path = vim.fn.expand(vim.fn.stdpath("data") .. "/mason/packages/java-test") -- Add all of the Jars for running tests in debug mode to the bundles list
...
local function get_workspace()
  ...
  local home = vim.fn.expand(vim.fn.stdpath("data"))
