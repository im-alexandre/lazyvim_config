...
return {
  ...
  config = function()
    ...
    local models = {
      ...
      ["gpt-5.1-codex"] = "gpt-5.1-codex", -- só vai funcionar se sua API realmente listar esse modelo
      ["gpt-5.1-codex-max"] = "gpt-5.1-codex-max", -- só vai funcionar se sua API realmente listar esse modelo
    }
